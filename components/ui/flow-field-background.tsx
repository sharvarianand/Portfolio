...
interface NeuralBackgroundProps {
    ...
    speed?: number;
    /**
     * Background color for the trails.
     * Should match the container background.
     * Default: "#000000"
     */
...
export default function NeuralBackground({
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            // Convert hex to rgb for rgba trail
            ...
            ctx.fillStyle = backgroundColor.startsWith('#')
                ? `rgba(${getRGB(backgroundColor)}, ${trailOpacity})`
                : backgroundColor; // Fallback if not hex

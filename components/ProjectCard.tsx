...
const ProjectCard = ({ name, description, tags, github, demo, image }: ProjectCardProps) => {
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden bg-gradient-light-primary/10 dark:bg-gradient-primary/10">
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="font-heading text-xl mb-3 gradient-text">{name}</h3>
        <p className="text-light-text-secondary dark:text-text-secondary text-sm mb-4 line-clamp-2 leading-relaxed flex-grow">{description}</p>
        ...
        <div className="flex gap-4 mt-auto">
          <a
            ...
            className="flex-1 px-4 py-2 rounded-lg text-center font-heading text-sm border border-light-primary dark:border-primary text-light-primary dark:text-primary hover:bg-light-primary/10 dark:hover:bg-primary/10 transition-colors duration-300"
          >
            Code
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 px-4 py-2 rounded-lg text-center font-heading text-sm bg-gradient-light-primary dark:bg-gradient-primary text-white hover:opacity-90 transition-opacity duration-300"
          >
            Live Demo
          </a>
        </div>
